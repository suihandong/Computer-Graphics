...
protected:
    ...
    std::vector<Point2> plane_tex_coords;
    std::vector<Point2> sphere_tex_coords;
    std::vector<Vector3> plane_norm;
    std::vector<Vector3> sphere_norm;
};
