...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
    ...
    //Motion 3
    ballet_special3_.LoadFromAMC(Platform::FindFile("05_06.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ...
    //Motion4
    ballet_special4_.LoadFromAMC(Platform::FindFile("05_09.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ...
    //Motion 5
    ballet_special5_.LoadFromAMC(Platform::FindFile("05_18.amc", searchPath_), *ballet_ant_.skeleton_ptr());
